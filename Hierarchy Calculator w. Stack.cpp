/*****************************************************************
CODE BY :
Muhammad Daffa Abiyyu Rahman [2916100010]
...
///Since system doesn't work on zero tier stack, we need to add one more tier
...
///How many multiplier and division need to be reformatted?
    ...
    if (ParBalance(data,true))
        {
            ...
            if (Valid(data))
            {
                ...
                tempdata = data;
                cout << "To properly count the equation, the formula has been reformed into : " << data << endl << endl; ///View the final equation form
